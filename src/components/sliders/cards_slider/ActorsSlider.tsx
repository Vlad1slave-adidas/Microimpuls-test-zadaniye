...
function ActorsSlider({ slider }: { slider: ActorCardProps[] }) {
	...
	return (
		...
		>
			<h2 className='px-px-default max-xl:px-px-xl max-lg:px-px-lg text-text-default-active text-[32px] font-semibold max-xl:text-[30px]'>
				Актеры
			</h2>
			<div
				className='relative'
			...
			>
				...
				<div className='relative w-full overflow-hidden'>
					<div
						ref={containerRef}
						className='px-px-default max-xl:px-px-xl max-lg:px-px-lg flex w-full gap-x-10 overflow-x-hidden py-6'
					>
						{slider.map(item => (
							<div key={item.id}>
								<ActorCard
